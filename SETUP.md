...
| `BWS_ENDPOINT` | `face.bws-eu.bioid.com` | BioID service endpoint |
| `BIOID_PREFERRED_REGION` | `EU` | Preferred region (EU, US, SA) |
| `BIOID_VERIFICATION_THRESHOLD` | `0.015` | Face verification threshold (0.0-1.0, lower = more strict) |
| `BIOID_MAX_RETRIES` | `3` | Maximum verification retries |
| `BIOID_LIVENESS_ENABLED` | `true` | Enable liveness detection |
| `BIOID_TEMPLATE_TTL_DAYS` | `365` | Template expiration in days |
