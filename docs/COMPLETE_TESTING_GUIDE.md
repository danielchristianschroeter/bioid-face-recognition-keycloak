...
### 2.2 Select bioid Login theme

1. **Click** Create or select your Realm where you want to enable Face Recognition
2. **Click** Open Realm Settings
3. **Click** Open "Themes" tab and select `bioid` within Login theme
...
2. **Verify**: "Face Recognition Enrollment" is enabled
